...
class Compass():
    ...
    def __init__(self, i):
        ...
        self.__i2c = i
        self.__i2c.writeto(__COMPASS_ADDR, __COMPASS_WRITE_A)
        self.__i2c.writeto(__COMPASS_ADDR, __COMPASS_WRITE_B)
    ...
    def __read_sensor(self):
        ...
        [x, y, z] = [((reading[i] << 8) | reading[i + 1]) for i in range(0, 6, 2)]
        x = x * 0.00092
        y = y * 0.00092
        z = z * 0.00092
